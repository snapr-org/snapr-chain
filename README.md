## snapr chain
snapr chain is written in [Rust](https://www.rust-lang.org/). A basic familiarity with Rust tooling is required.

To learn more about snapr chain, please refer to **[Documentation](https://snapr.org/)**.
